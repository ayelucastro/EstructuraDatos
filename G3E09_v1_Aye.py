...
def main():
    ...
    #D: el enunciado pide usar la lista original. Para eso, tendríamos que realizar una copia de la misma
    #antes de modificarla. Como no vimos cómo copiar una 'lista', vamos a omitirlo y usamos la 
    # lista_modificada.
    lista_menores, tope  = generar_nueva_lista(segunda_lista)
    print(f"La lista de los numeros menores a {tope} es:")
    print_list(lista_menores)
